...
func collection_append_remove():
	...
	# each item is used as arguments for the referenced function
	# as_args only works with lists of arrays
	
	var r = connections.as_args(funcref(people, "connect")).to_array()
